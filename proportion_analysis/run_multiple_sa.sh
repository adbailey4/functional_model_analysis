...
cat << EOF >> config.json
{
  ...
  "samples": [
    {
      "positions_file": null,
      "fast5_dirs": ["$cwd/FAB39088/fast5"],
      "bwa_reference": "$cwd/forward.FAB39088_na12878.GRCh38_full_analysis_set_plus_decoy_hla.fa",
      "fofns": [],
      "readdb": "$cwd/FAB39088/FAB39088.readdb",
      "fw_reference": "$cwd/forward.FAB39088_na12878.GRCh38_full_analysis_set_plus_decoy_hla.fa",
      "bw_reference": "$cwd/backward.FAB39088_na12878.GRCh38_full_analysis_set_plus_decoy_hla.fa",
      "kmers_from_reference": false,
      "motifs": null,
      "name": "FAB39088_na12878",
      "probability_threshold": 0.7,
      "number_of_kmer_assignments": 10000,
      "alignment_file": "$cwd/FAB39088/FAB39088_top_100_chr1_variant.sorted.bam",
      "recursive": false,
      "assignments_dir": null
    },
    {
      "positions_file": null,
      "fast5_dirs": ["$cwd/FAF01169/fast5"],
      "bwa_reference": "$cwd/forward.FAB39088_na12878.GRCh38_full_analysis_set_plus_decoy_hla.fa",
      "fofns": [],
      "readdb": "$cwd/FAF01169/FAF01169.readdb",
      "fw_reference": "$cwd/forward.FAB39088_na12878.GRCh38_full_analysis_set_plus_decoy_hla.fa",
      "bw_reference": "$cwd/backward.FAB39088_na12878.GRCh38_full_analysis_set_plus_decoy_hla.fa",
      "kmers_from_reference": false,
      "motifs": null,
      ...
      "probability_threshold": 0.7,
      "number_of_kmer_assignments": 10000,
      "alignment_file": "$cwd/FAF01169/FAF01169_top_100_chr1_variant.sorted.bam",
      "recursive": false,
      "assignments_dir": null
    }
  ],
