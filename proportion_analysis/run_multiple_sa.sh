...
cat << EOF >> config.json
{
  ...
  "samples": [
    {
      "positions_file": "$cwd/top_chr1_variant.positions",
      "fast5_dirs": ["$cwd/FAB39088/fast5"],
      "bwa_reference": "$cwd/GRCh38_full_analysis_set_plus_decoy_hla.fa",
      "fofns": [],
      ...
      "alignment_file": "$cwd/FAB39088/FAB39088_top_chr1_variant.sorted.bam",
      "recursive": false,
    ...
    },
    {
      ...
      "probability_threshold": 0.7,
      "number_of_kmer_assignments": 10000,
      "alignment_file": "$cwd/FAF01169/FAF01169_top_chr1_variant.sorted.bam",
      "recursive": false,
      "assignments_dir": null
    }
  ],
